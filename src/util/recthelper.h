...
constexpr DPoint operator*(DPoint lhs, double rhs) { return {lhs.x * rhs, lhs.y * rhs}; }

constexpr DPoint operator*=(DPoint &lhs, double rhs) {
    lhs.x = lhs.x * rhs;
    lhs.y = lhs.y * rhs;
    return lhs;
}

constexpr DPoint operator+=(DPoint &lhs, DPoint rhs) {
    lhs.x = lhs.x + rhs.x;
    lhs.y = lhs.y + rhs.y;
    return lhs;
}
...
constexpr SDL_Point &operator*=(SDL_Point &lhs, const int rhs) {
    lhs = lhs * rhs;
    return lhs;
}
...
constexpr SDL_Rect operator+(const SDL_Rect lhs, const SDL_Rect rhs) {
...
constexpr SDL_Rect &operator+=(SDL_Rect &lhs, const SDL_Rect rhs) {
    lhs = lhs + rhs;
    return lhs;
}
...
constexpr SDL_Rect operator+(const SDL_Point lhs, const SDL_Rect rhs) {
    return {lhs.x + rhs.x, lhs.y + rhs.y, rhs.w, rhs.h};
}

constexpr SDL_Rect operator+(const SDL_Rect lhs, const SDL_Point rhs) {
...
constexpr SDL_Rect &operator*=(SDL_Rect &lhs, const int rhs) {
    lhs = lhs * rhs;
    return lhs;
}
...
constexpr SDL_FPoint operator+(const SDL_FPoint lhs, const SDL_FPoint rhs) {
...
constexpr SDL_FPoint &operator+=(SDL_FPoint &lhs, const SDL_FPoint rhs) {
    lhs = lhs + rhs;
    return lhs;
}
...
constexpr SDL_FPoint &operator*=(SDL_FPoint &lhs, const float rhs) {
    lhs = lhs * rhs;
    return lhs;
}
...
constexpr SDL_FRect operator+(const SDL_FRect lhs, const SDL_FRect rhs) {
    return {lhs.x + rhs.x, lhs.y + rhs.y, lhs.w + rhs.w, lhs.h + rhs.h};
}
...
constexpr SDL_FRect &operator+=(SDL_FRect &lhs, const SDL_FRect rhs) {
    lhs = lhs + rhs;
    return lhs;
}
...
constexpr SDL_FRect operator+(const SDL_FPoint lhs, const SDL_FRect rhs) {
    return {lhs.x + rhs.x, lhs.y + rhs.y, rhs.w, rhs.h};
}

constexpr SDL_FRect operator+(const SDL_FRect lhs, const SDL_FPoint rhs) {
    return {lhs.x + rhs.x, lhs.y + rhs.y, lhs.w, lhs.h};
}
...
constexpr SDL_FRect &operator+=(SDL_FRect &lhs, const SDL_FPoint rhs) {
    lhs = lhs + rhs;
    return lhs;
}
...
constexpr SDL_FRect operator*(const SDL_FRect lhs, const float rhs) {
    return {lhs.x, lhs.y, lhs.w * rhs, lhs.h * rhs};
}
...
constexpr SDL_FRect &operator*=(SDL_FRect &lhs, const float rhs) {
    lhs = lhs * rhs;
    return lhs;
}
